...
const products = [
    ...
    },
    {
      id:11,
      img: [i13],
      name: "Rangs RAC-14SH 01 Ton Split Type AC",
      desc: " Wi-Fi support , Connectivity Module inbuilt / Separate module, Connecting tube(CU with insulation) between IDU & ODU : Length",
      unit:'lb',
      sale:1.0,
      discount:0,
      quantity:100,
